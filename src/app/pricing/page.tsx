        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <motion.div initial="hidden" animate="visible" variants={fadeUp} transition={{ delay: 0.4 }} className="h-full">
              <MagicCard 
                className="w-full h-full bg-white p-8 md:p-10 rounded-3xl shadow-xl flex flex-col relative group overflow-hidden border-[#c9956b]/30"
                gradientColor="#c9956b20"
                gradientSize={400}
              >
                {/* Premium Glow */}
                <div className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-[#8b4c5e] via-[#c9956b] to-[#8b4c5e] z-10" />
